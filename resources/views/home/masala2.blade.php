...
<body>
            ...
            <div class="customer-form">
                ...
                <form id="orderForm">
                    ...
                    <div class="form-group">
                        ...
                        <small>(⚠️ ভুল নম্বর হলে অর্ডার নিশ্চিত হবে না )</small>
                        <input type="tel" id="phone" required>
                    </div>

                    <div class="form-group">
                        <label>সম্পূর্ণ ঠিকানা *</label>
                        <textarea rows="4" id="address" required></textarea>
                    </div>
    ...
    <footer>
        ...
        <p style="margin-top: 10px; font-size: 14px;"><i class="fa-solid fa-headset"></i> +880 9640-646464 | <i
                class="fa-brands fa-whatsapp"></i> <a href="https://wa.me/8801344314426"
                style="color: white; text-decoration: none;">01344-314426 </a> </p>
    </footer>
    ...
    <script>
        ...
        function updatePrice() {
            ...
            if (productPriceEl) productPriceEl.innerText = total + " ৳";
        ...
        function submitForm(event) {
            ...
            const whatsappNumber = '8801234567890'; // change this
...
দয়া করে কনফার্ম করুন।`;

            const url = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(message)}`;

            alert('ধন্যবাদ! আপনাকে ফোন করে অর্ডারটি কনফার্ম করা হবে। ');
            // name..value = '';
            // phone..value = '';
            // address..value = '';
    ...
    <script>
        ...
        function submitForm(event) {
            ...
            const data = {
                ...
                subtotal: total,
                total: total,
                product: `রসুন, আম, তেঁতুল ও চালতার আচার (${quantity} পিস)`
            };
